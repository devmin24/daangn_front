...
- 하단의 인기중고 리스트는 인기매물 리스트의 일부분을 보여줍니다. 8개만 보여주기 위해 `slice` 내장함수를 사용해 총 리스트에서 8개를 잘라 사용했습니다.
- 하단의 인기중고 리스트 클릭 시 데이터는 변경되나, 스크롤이 상단으로 올라가지 않는 이슈가 생겨 `scrollTo(0,0)` 내장함수를 사용해 해결했습니다.

### 6. 배포

<center><img src="https://images.velog.io/images/pmk4236/post/2a16a2eb-fe4c-46e2-b474-4a04c0ff6e0d/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202021-04-11%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%204.30.52.png" width="50%"></center>

- AWS S3 버킷을 사용해 배포했습니다. 배포 링크에서 reload시 404 error 발생 이슈가 생겨, **\*버킷 속성 - 정적 웹 사이트 호스팅에서 error document에 index.html을 입력**하는 방법으로 간단히 해결했습니다.
